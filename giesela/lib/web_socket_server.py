...
class SimpleWebSocketServer(object):
    ...
    def __init__(self, host, port, websocketclass, selectInterval=0.1) -> None:
        ...
        self.guildsocket.bind((host, port))
        self.guildsocket.listen(5)
        self.selectInterval = selectInterval
        self.connections = {}
        self.listeners = [self.guildsocket]
    ...
    def serveforever(self):
        while True:
            ...
            for ready in rList:
                if ready == self.guildsocket:
                    sock = None
                    try:
                        sock, address = self.guildsocket.accept()
