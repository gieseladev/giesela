...
class Playlists:
    ...
    def __init__(self, playlists_file):
        ...
        Path(self.playlist_save_location).mkdir(parents=True, exist_ok=True)
    ...
    def edit_playlist(self, playlist_id, queue, all_entries=None, remove_entries=None, remove_entries_indexes=None, new_entries=None, new_name=None,
                      new_description=None, new_cover=None, edit_entries=None):
    ...
    async def mark_entry_broken(self, queue, playlist_id, entry):
        ...
        print("marked {} from {} as broken".format(entry.title, playlist["name"]))
