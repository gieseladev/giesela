...
class Tweet:
    ...
    def from_id(cls, tweet_id):
        ...
        kwargs = {"created_at": datetime.strptime(status.created_at, "%a %b %d %H:%M:%S %z %Y"),
    ...
    def __repr__(self):
        return "{0.user}: {0.text}".format(self)
...
credentials = {"consumer_key": "CcleNL3BCTXxGVr39fdK5SBBH", "consumer_secret": "tcF3bWoAcgRaCYOZGy4jNpzHPTdWBUL9RjtYCoqGq6Q3tm4Kbj",
               "access_token_key": "3027865895-eWngTcWlnZnZgK5HHd9FBgIW4ywEgrkdb5pHDTd", "access_token_secret": "YOakSjoSFPPIwt6kimoWLWgNuGj2tJXNSafKjMwTca1pR"}
