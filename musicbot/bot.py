                        ...
                        async for ind, entry in entry_generator:
                            ...
                            if round(100 * (ind + 1) / total_entries) % 1 == 0:
                                ...
                                expected_time = avg_time * \
                                    (total_entries - ind - 1)
                                await self.safe_edit_message(percentage_message, "***REMOVED******REMOVED*** [***REMOVED******REMOVED***%] (***REMOVED******REMOVED*** remaining)".format(create_bar((ind + 1) / total_entries, length=20), round(100 * (ind + 1) / total_entries), format_time(expected_time)))
