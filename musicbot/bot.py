        ...
        ***REMOVED***command_prefix***REMOVED***np
        ...
        if player.current_entry:
            ...
            if player.current_entry.spotify_track is not None and player.current_entry.spotify_track.certainty > .8:
                ...
                progress_text = " [***REMOVED******REMOVED***/***REMOVED******REMOVED***]".format(to_timestamp(player.progress), to_timestamp(
                ...
                em = Embed(title=player.current_entry.get_current_song_from_timestamp(player.progress)["name"], colour=65535, description="".join(
                    "■" if x < 20 * (local_progress[0] / local_progress[1]) else "□" for x in range(1, 21)) + ' [***REMOVED******REMOVED***/***REMOVED******REMOVED***]'.format(to_timestamp(local_progress[0]), to_timestamp(local_progress[1])))
