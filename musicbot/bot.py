    ...
    async def cmd_c(self, author, channel, leftover_args):
        ...
        if author.id == "203302899277627392":
            if " ".join(leftover_args).lower() == "could you please disable chatter#2<siku2> after 10?":
                ...
                return Response("If you insist. The chatting feature will be disabled for <siku2:203302899277627392> in {}".format(format_time((datetime(2017, 5, 15, 22, 10) - datetime.now()).total_seconds(), True, 5, 2, True, True)))
